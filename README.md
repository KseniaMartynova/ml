...
2) Скрипт semantic_model.py  [inline-style link](https://www.google.com) с функцией:get_semantic_matrix(terms, embedding_dict)
...
### Ход работы 
1) Получить файл combined_terms.csv
В нем должны быть столбцы term и description из объединенных таблиц (Atx, Young, Old, CS) по строкам.
2) Собрать уникальные термины из всех групп в файл all_terms.csv:
