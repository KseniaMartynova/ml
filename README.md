...
Всего кластеров получилось 26. Однако получилось слишком много кластеров с количеством терминов <=2 и несколько кластеров с непомерно большим количеством терминов. Нас интересует семантическое сходство ≥ 0.7, в таблице ниже представлена семантическое расстояние, чем оно больше, тем лушче связаны по смыслу термины в кластере, кластеры размером менее 2 не пердставлены в таблице.
| Кластер | Расстояние | Оценка           | Размер кластера |
|---------|------------|------------------|-----------------|
...
Это все очень нехорошо и достаточно бессмысленно для нашей задачи. Поэтому попробуем еще DBSCAN.
